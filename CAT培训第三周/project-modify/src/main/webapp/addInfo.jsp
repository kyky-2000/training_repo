...
<head>
    ...
    <script>
        ...
        function addInfo(){
            ...
            var json = {"userId": user.id, "name": name, "photo": photo, "introduce": introduce, "gameCareer1": gameCareer1, "gameCareer2": gameCareer2,
                "gameCareer3": gameCareer3, "salary": salary+"", "pictures[0]": photo1, "pictures[1]":photo2, "pictures[2]": photo3, "status": status};
    ...
    <form method="post">
        <div class="form-group">
            <form id="photoForm" enctype="multipart/form-data">
                ...
                <input type="file" name="upload" id="photo" required=""/>
